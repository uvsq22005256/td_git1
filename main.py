...
bouton_egal = Button(racine, text="=", width = 5, activebackground = "Black", activeforeground = "White", command = egal)
bouton_supprime = Button(racine, text="C", width = 5, activebackground = "Black", activeforeground = "White", command = reset)
label_affichage = Label(racine, text=affichage, bg="black", fg = "white", width = 26)
bouton_point = Button(racine, text=".", width = 5, activebackground = "Black", activeforeground = "White", command = lambda: addNum("."))
